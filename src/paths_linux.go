...
var (
	...
	HOST_CONFIG_DIR_PATH HOST_CONFIG_PATH = HOST_CONFIG_PATH(filepath.Join("/", "etc", "custodiajs"))

	// Log Pfade
	//LINUX_DEFAULT_LOGGING_DIR_PATH  types.LOG_DIR = types.LOG_DIR(filepath.Join("var", "log", "CustodiaJS"))
	DEFAULT_LOGGING_DIR_PATH LOG_DIR = LOG_DIR(filepath.Join("/", "var", "log", "custodiajs"))
